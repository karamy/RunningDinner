...
@NgModule({
  ...
  declarations: [ContactsDetailPage, CountryCodesPage],
  entryComponents: [ContactsDetailPage, CountryCodesPage] // Dichiaro le pagine come entryComponents per essere disponibili al ModalController di Ionic
})
